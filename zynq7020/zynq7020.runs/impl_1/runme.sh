...
HD_PWD='C:/Users/Aaro/Documents/GitHub/vivado_shenanigans/zynq7020/zynq7020.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_blink.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_blink.tcl -notrace
